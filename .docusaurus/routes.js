...
export default [
  {
    path: '/alsys_admin_cards/__docusaurus/debug',
    component: ComponentCreator('/alsys_admin_cards/__docusaurus/debug', '240'),
    exact: true
  },
  {
    path: '/alsys_admin_cards/__docusaurus/debug/config',
    component: ComponentCreator('/alsys_admin_cards/__docusaurus/debug/config', '1dc'),
    exact: true
  },
  {
    path: '/alsys_admin_cards/__docusaurus/debug/content',
    component: ComponentCreator('/alsys_admin_cards/__docusaurus/debug/content', '41e'),
    exact: true
  },
  {
    path: '/alsys_admin_cards/__docusaurus/debug/globalData',
    component: ComponentCreator('/alsys_admin_cards/__docusaurus/debug/globalData', 'f55'),
    exact: true
  },
  {
    path: '/alsys_admin_cards/__docusaurus/debug/metadata',
    component: ComponentCreator('/alsys_admin_cards/__docusaurus/debug/metadata', 'bff'),
    exact: true
  },
  {
    path: '/alsys_admin_cards/__docusaurus/debug/registry',
    component: ComponentCreator('/alsys_admin_cards/__docusaurus/debug/registry', '0dc'),
    exact: true
  },
  {
    path: '/alsys_admin_cards/__docusaurus/debug/routes',
    component: ComponentCreator('/alsys_admin_cards/__docusaurus/debug/routes', '684'),
    exact: true
  },
  {
    path: '/alsys_admin_cards/blog',
    component: ComponentCreator('/alsys_admin_cards/blog', 'd57'),
    exact: true
  },
  {
    path: '/alsys_admin_cards/blog/archive',
    component: ComponentCreator('/alsys_admin_cards/blog/archive', '979'),
    exact: true
  },
  {
    path: '/alsys_admin_cards/blog/first-blog-post',
    component: ComponentCreator('/alsys_admin_cards/blog/first-blog-post', '7a8'),
    exact: true
  },
  {
    path: '/alsys_admin_cards/blog/long-blog-post',
    component: ComponentCreator('/alsys_admin_cards/blog/long-blog-post', '5e5'),
    exact: true
  },
  {
    path: '/alsys_admin_cards/blog/mdx-blog-post',
    component: ComponentCreator('/alsys_admin_cards/blog/mdx-blog-post', 'a7a'),
    exact: true
  },
  {
    path: '/alsys_admin_cards/blog/tags',
    component: ComponentCreator('/alsys_admin_cards/blog/tags', '1e4'),
    exact: true
  },
  {
    path: '/alsys_admin_cards/blog/tags/docusaurus',
    component: ComponentCreator('/alsys_admin_cards/blog/tags/docusaurus', '6b7'),
    exact: true
  },
  {
    path: '/alsys_admin_cards/blog/tags/facebook',
    component: ComponentCreator('/alsys_admin_cards/blog/tags/facebook', '812'),
    exact: true
  },
  {
    path: '/alsys_admin_cards/blog/tags/hello',
    component: ComponentCreator('/alsys_admin_cards/blog/tags/hello', '196'),
    exact: true
  },
  {
    path: '/alsys_admin_cards/blog/tags/hola',
    component: ComponentCreator('/alsys_admin_cards/blog/tags/hola', '055'),
    exact: true
  },
  {
    path: '/alsys_admin_cards/blog/welcome',
    component: ComponentCreator('/alsys_admin_cards/blog/welcome', 'd5a'),
    exact: true
  },
  {
